  ...
  if(isset($_POST['kwota']))
  {
    ...
    try 
    {
      ...
      else
      {
        ...
        {
         $userId = $_SESSION['id'];  
          if ($polaczenie->query("INSERT INTO incomes VALUES (NULL, '$userId', $kategoria, '$kwota', '$data', '$opis')"))
          {            
              $_SESSION['komunikat']="Przychód został zarejestrowany!";
          }
          else
          {
	  ...
	  <nav class="navbar navbar-light bg-faded navbar-expand-sm">
	    ...
	    <div class="collapse navbar-collapse navbar-toggleable-md" id="navbarNavAltMarkup">
	        <div class="navbar-nav mx-auto">
	            <a class="nav-link active" href="przychod.php">Przychód</a>
		...
		<div class="container bg-white text-center" style="max-width:450px; margin:auto; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
			<h1 style="margin-top: 10px; padding-top: 15px;">PRZYCHÓD</h1>
			...
			<form method="post">
					...
					<div class="dropdown flex-grow-1">					
						<?php
							...
							$userId = $_SESSION['id'];  
								...
								$q = "SELECT id, name FROM incomes_category_assigned_to_users where user_id = $userId";
				...
				<div class="w-100 mt-4">
					<button type="submit" class="btn btn-primary mr-2">Dodaj przychód</button>	
				</div>
